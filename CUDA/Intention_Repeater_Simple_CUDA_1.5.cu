...
void print_help()
{
    ...
    cout << " f) --file or -f, example: --file \"intentions.txt\" [File to Use]" << endl;
    cout << " g) --file2 or -f2, example: --file2 \"me.jpg\" [Second File to Use]" << endl;
    cout << " h) --help or -? [This help]" << endl;
}
...
int main(int argc, char **argv)
{
    ...
    string useHashing, useCompression, param_compress = "X", param_file = "X", intention_display = "", param_file2="X", intention_value="";
    int numGBToUse = 1;
